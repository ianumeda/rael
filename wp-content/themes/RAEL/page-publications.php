...
<div class="row">
      <div class=" content">
        <div class="row">
          ...
          ?>
          <?php
          $query = new WP_Query( array( 'post_type' => 'publications','posts_per_page' => '1', 'order' => 'ASC', 'orderby' => 'title', 'tag__in'=>array(80)));
        ...
        <?php
          $query = new WP_Query( array( 'post_type' => 'publications', 'posts_per_page' => '-1', 'offset' => '0', 'order' => 'ASC', 'orderby' => 'title' ));
          if ( $query->have_posts() ) {
            $number_of_columns=4;
            ...
            echo '<div class="row">'; // wraps the whole people grid
              ...
              if($current_post_in_current_column==0){
                echo '<div class="col-sm-12 col-md-6 column_level_2">';
              }
          		$query->the_post();
