  ...
  <div class="col-lg-10 col-lg-offset-1 ">
    <div class="row">
      ...
      <div class="col-md-10 content">
          ...
          ?>
          <?php
          $query = new WP_Query( array( 'post_type' => 'people', 'position'=>'alumni', 'posts_per_page' => '-1', 'order' => 'ASC', 'orderby' => 'title', 'tag__in'=>array(80)));
          ...
          wp_reset_postdata();
        ?>    
        <h3 class="section_heading">All Alumni</h2>
        <?php
